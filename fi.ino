...
switch (robotStatus) {
  case 0: // Default no input
   setBubbleColor(2370,strip.ColorHSV(65535));
    
    break;
    
  case 1:// Driving Away From Feeding Station
setBubbleColor(2370,strip.ColorHSV(65535/2));
    break;
    
  case 2://Have Coral
setBubbleColor(2370,strip.ColorHSV(65535/3));
    break;
    
  case 3://Have Algae
setBubbleColor(2370,strip.ColorHSV(65535/4));
    break;
    
  case 4://Able to score
setBubbleColor(2370,strip.ColorHSV(65535/5));
    break;
    
  case 5:
setBubbleColor(2370,strip.ColorHSV(65535/6));
    break;
    
  case 6:// Climbing Red
setBubbleColor(2370,strip.ColorHSV(65535/7));
    break;
    
  case 7://Climbing Blue
setBubbleColor(2370,strip.ColorHSV(65535/8));
    break;
...
for(int i=0;i<31;i++){
  setBubbleColor(i, strip.ColorHSV((65536/64*(i+(32-loopcount)))));
